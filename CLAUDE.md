...
- **Current version:** 1.17 (`APP_VERSION` in `js/app.js` *and* `sw.js`)
...
tools/smoke-test.js    125 end-to-end browser checks
...
node tools/smoke-test.js                  # 125 checks, expect 125/125
```
